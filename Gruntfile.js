module.exports = function(grunt) {
				...
				files: [
					{
						...
						dest: '/Applications/MAMP/htdocs/projekt/templates/kicktemp/js',    // destination folder
				...
				files: [
					{
						...
						src: '**/*',           // copy all files and subfolders
						dest: '/Applications/MAMP/htdocs/projekt/templates/kicktemp/css',    // destination folder
						expand: true           // required when using cwd
					}
				]
			}
	...
	grunt.registerTask('copy-to-template', ['copy:jstotemplate', 'copy:csstotemplate']);

	// Default task.
	grunt.registerTask('cleantemplate', ['clean:css', 'clean:js']);
	grunt.registerTask('firststart', ['copy:bootstrapfonts' , 'copy:fontawesomefonts', 'copy:html5shiv', 'copy:respond', 'copy:html5shiv' ,'copy:respond', 'copy:bootstrapvariables', 'copy:fontawesomevariables']);
