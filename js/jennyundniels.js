/*!
 * jennyundniels v2.0.0 (http://www.nn-medienagentur.de)
 * Copyright 2015-2015 Niels Nübel. NN-Medienagentur
...
(function($){
	$(document).ready(function(){
		...
		if (Modernizr.mq('only all and (max-width: 767px)') || Modernizr.touch || $(".main-navigation.onclick").length>0 ) {
			$('.header-top [data-toggle=dropdown], button[data-toggle=dropdown]').on('click', function(event) {
		...
		$(".main-navigation ul.level_1 li.dropdown").bind({
